    ...
    <>
      <div>
        ...
        {sections.map((section, index) => {
          const jobTitle = section.jobTitle;
          const employer = section.employer;
          ...
          const isAnyFieldFilled = jobTitle || employer || city || startDate || endDate;
                  ...
                  {isAnyFieldFilled ? (
                    <>
                      <p className="flex justify-between">
                        <span className='font-[600]'>{`${jobTitle || 'Job'} at ${employer || 'Employer'}, ${city || 'City'}`}</span>
                      </p>
                ...
                <div className="flex flex-col gap-5 mt-3">
                  <div className="flex gap-7 w-full flex-col lg:flex-row lg:flex-nowrap">
                    <div className="flex flex-col gap-2 w-full max-w-[360px]">
                      <label className="text-[#999999] text-[14px]">Job Title</label>
                      <input
                        type="text"
                        className="rounded border-[1px] p-[10px] px-[16px] font-[500] border-gray"
                        value={section.jobTitle}
                        onChange={(e) => handleInputChange(index, e, 'jobTitle')}
                        placeholder=""
                      />
                    </div>
                    <div className="flex flex-col gap-2 w-full max-w-[360px]">
                      <label className="text-[#999999] text-[14px]">Employer</label>
                      <input
                        type="text"
                        className="rounded border-[1px] p-[10px] px-[16px] font-[500] border-gray"
                        value={section.employer}
                        onChange={(e) => handleInputChange(index, e, 'employer')}
                        placeholder=""
                      />
                    </div>
                  </div>
